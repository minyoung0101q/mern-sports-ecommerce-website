...
### 📝배포 **
+ AWS EC2 배포 계획  <br />
저는 추후에 이 프로젝트를 AWS EC2를 활용해 배포하고자 합니다.
<br />AWS EC2에 Nginx를 설치하고, Nginx를 사용하여 배포한다면 애플리케이션을 안정적으로 서비스할 수 있고, 애플리케이션의 로드 밸런싱을 수행할 수 있으며 HTTPS를 지원하는 SSL 인증서를 적용할 수 있습니다.
<br />
이렇게 Nginx는 안정적이고 확장 가능한 애플리케이션을 제공할 수 있지만, 많은 구성이 필요합니다. 
<br /> 우선적으로 애플리케이션을 배포하는 데 사용되는 구성이 단순한 방법을 적용할 것입니다.
<br /> **바로 AWS EC2에 직접 배포하는 방법입니다!**
<br /> 
AWS EC2를 익혀서 배포로 이 프로젝트를 마무리 할 것입니다.
<br />긴 글 읽어주셔서 감사합니다:)
